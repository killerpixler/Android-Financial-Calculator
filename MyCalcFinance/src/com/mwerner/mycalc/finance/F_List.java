	...
	public void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (mDualPane) {
			...
			case 1:
				...
				FragmentTransaction ft1 = getActivity()
						.getSupportFragmentManager().beginTransaction();
			...
			case 2:
				...
				FragmentTransaction ft2 = getActivity()
						.getSupportFragmentManager().beginTransaction();
			...
			case 3:
				...
				FragmentTransaction ft3 = getActivity()
						.getSupportFragmentManager().beginTransaction();
			...
			case 4:
				...
				FragmentTransaction ft4 = getActivity()
						.getSupportFragmentManager().beginTransaction();
			...
			case 5:
				...
				FragmentTransaction ft5 = getActivity()
						.getSupportFragmentManager().beginTransaction();
			...
			case 6:
				...
				FragmentTransaction ft6 = getActivity()
						.getSupportFragmentManager().beginTransaction();
			...
			case 7:
				...
				FragmentTransaction ft7 = getActivity()
						.getSupportFragmentManager().beginTransaction();
