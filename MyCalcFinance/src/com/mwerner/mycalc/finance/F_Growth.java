...
public class F_Growth extends Fragment {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
			...
			public void onClick(View arg0) {
				...
				if (emptyfieldss > 1) {
					...
					case 1://g
						...
						answer.setText("The growth rate is: " + result1 + "or " + result11);
						break;
					case 2://div0
						...
						answer.setText("The dividends today were " + result2);
						break;
					case 3://div_t
						...
						answer.setText("The dividens -T- years ago were " + result3);
						break;
					case 4://t
						...
						answer.setText("It has been " + result4 +" between the dividend payments.");
						break;
		...
		Button info = (Button) getActivity().findViewById(R.id.growth_infobutton);
